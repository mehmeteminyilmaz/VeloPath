...
const ProjectDetails = ({ projects, addTask, toggleTask, deleteProject, deleteTask, updateTaskNote, reorderTasks, archiveProject, resetData, requestNotificationPermission }) => {
  const { id } = useParams();
